...
import com.dawes.services.ContenedoresRutasService;

@Service
public class ContenedoresRutasServiceImpl implements ContenedoresRutasRepo, ContenedoresRutasService {
	...
	public List<ContenedoresRutasVO> BuscarContenedoresRuta(int idcontenedor) {
		return crr.BuscarContenedoresRuta(idcontenedor);
	}
